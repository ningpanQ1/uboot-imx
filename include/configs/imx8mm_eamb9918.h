...
#define M2_PWR_EN			IMX_GPIO_NR(1, 14)
#define M2_RESET			IMX_GPIO_NR(1, 11)
#define EAMB9918_LCD_SELECT0			IMX_GPIO_NR(5, 3)
#define EAMB9918_LCD_SELECT1			IMX_GPIO_NR(5, 5)
